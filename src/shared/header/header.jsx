...
const blogLinks = [
  ...
  { link: 'Structural-Engineer-Kensington-Building-Strong-Foundations-with-PEPP', text: "Structural Engineer Kensington: Building Strong Foundations with PEPP", icon: faBalanceScale },
  { link: 'Why-Developers-and-Homeowners-Trust-Structural-Engineers-in-Lambeth-for-Reliable-Results', text: "Why Developers and Homeowners Trust Structural Engineers in Lambeth for Reliable Results", icon: faBalanceScale },
  { link: 'How-a-Structural-Engineer-in-Lambeth-London-Ensures-Your-Building-Meets-the-Highest-Safety-Standards', text: "How a Structural Engineer in Lambeth, London Ensures Your Building Meets the Highest Safety Standards", icon: faBalanceScale },
  { link: 'How-a-Structural-Engineer-in-Southwark-Prevents-Costly-Construction-Mistakes', text: "How a Structural Engineer in Southwark Prevents Costly Construction Mistakes", icon: faBalanceScale },
  { link: 'Why-Working-with-a-Structural-Engineer-in-the-London-Borough-of-Newham-Safeguards-Your-Investment', text: "Why Working with a Structural Engineer in the London Borough of Newham Safeguards Your Investment", icon: faBalanceScale },
  { link: 'How-an-Architect-Engineer-in-Kensington-Transforms-Complex-Visions-into-Functional-Living-Spaces', text: "How an Architect Engineer in Kensington Transforms Complex Visions into Functional Living Spaces", icon: faDraftingCompass },
  { link: 'How-an-Architect-Engineer-in-Oxford-Blends-Innovation-with-Traditional-British-Architecture', text: "How an Architect Engineer in Oxford Blends Innovation with Traditional British Architecture", icon: faDraftingCompass },
  { link: 'Engineers-and-Planners-in-Oxford-and-London-Building-Smarter-Sustainable-Spaces-with-PEPP', text: "Engineers and Planners in Oxford and London: Building Smarter, Sustainable Spaces with PEPP", icon: faBalanceScale },
  { link: 'Why-Collaboration-Between-Planners-and-Engineers-in-Oxford-Is-Key-to-Successful-Developments', text: "Why Collaboration Between Planners and Engineers in Oxford Is Key to Successful Developments", icon: faBalanceScale },
  { link: 'The-Growing-Importance-of-Integrated-Planners-and-Engineers-in-Oxford-and-London-for-Future-Ready-Infrastructure', text: "The Growing Importance of Integrated Planners and Engineers in Oxford and London for Future-Ready Infrastructure", icon: faBalanceScale },
  { link: 'The-Growing-Demand-for-Integrated-Planners-and-Engineers-in-Kensington-for-Smart-Urban-Design', text: "The Growing Demand for Integrated Planners and Engineers in Kensington for Smart Urban Design", icon: faBalanceScale },
  { link: 'Structural-Engineer-Kensington-UK-Expert-Solutions-by-PEPP', text: "Structural Engineer Kensington UK: Expert Solutions by PEPP", icon: faBalanceScale },
  { link: 'How-Collaboration-Between-Planners-and-Engineers-in-Cambridge-Reduces-Costs-and-Enhances-Quality', text: "How Collaboration Between Planners and Engineers in Cambridge Reduces Costs and Enhances Quality", icon: faBalanceScale },
  { link: 'Structural-Engineer-Westminster-Precision-Engineering-by-PEPP', text: "Structural Engineer Westminster: Precision Engineering by PEPP", icon: faBalanceScale },
  { link: 'Structural-Engineering-Services-in-Westminster-Strength-Safety-and-Sustainability-by-PEPP', text: "Structural Engineering Services in Westminster - Strength, Safety, and Sustainability by PEPP", icon: faBalanceScale },
  { link: 'Structural-Engineer-Oxford-Trusted-Experts-for-Safe-and-Sustainable-Structures', text: "Structural Engineer Oxford: Trusted Experts for Safe and Sustainable Structures", icon: faBalanceScale },
  { link: 'Structural-Engineers-Oxford-Why-Hiring-Professional-Structural-Engineers-in-Oxford-Is-Essential-for-Your-Building-Project', text: "Structural Engineers Oxford: Why Hiring Professional Structural Engineers in Oxford Is Essential for Your Building Project", icon: faBalanceScale },
  { link: 'How-a-Structural-Engineer-in-Cambridge-Ensures-Your-Renovation-Stands-the-Test-of-Time', text: "How a Structural Engineer in Cambridge Ensures Your Renovation Stands the Test of Time", icon: faBalanceScale },
  { link: 'How-Advanced-Digital-Tools-Are-Transforming-the-Work-of-Structural-Engineers-in-Cambridge', text: "How Advanced Digital Tools Are Transforming the Work of Structural Engineers in Cambridge", icon: faBalanceScale },
  { link: 'How-Cambridge-Structural-Engineers-Balance-Modern-Innovation-with-Historic-Preservation', text: "How Cambridge Structural Engineers Balance Modern Innovation with Historic Preservation", icon: faBalanceScale },
];
