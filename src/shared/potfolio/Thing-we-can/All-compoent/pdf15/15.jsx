...
export default function pdf15() {
  ...
  useEffect(() => {
    ...
    const extractImagesFromPDF = async () => {
      try {
        const loadingTask = pdfjsLib.getDocument("/drive-download-20250221T123148Z-001/Sample  Earth Retaining Steel Structure Stair Design.pdf");
