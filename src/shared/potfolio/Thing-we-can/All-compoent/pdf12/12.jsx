...
export default function pdf12() {
  ...
  useEffect(() => {
    ...
    const extractImagesFromPDF = async () => {
      try {
        const loadingTask = pdfjsLib.getDocument("/public/drive-download-20250221T123148Z-001/Sample   Residential Property Survey Sample 4.pdf");
