...
export default function Pdf27() {
  ...
  useEffect(() => {
    ...
    const extractImagesFromPDF = async () => {
      try {
        const loadingTask = pdfjsLib.getDocument("/drive-download-20250221T123148Z-001/Sample Rear Extension With 3D Prespectives.pdf");
