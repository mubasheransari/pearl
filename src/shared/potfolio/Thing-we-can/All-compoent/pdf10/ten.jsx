...
export default function Pdf10() {
  ...
  useEffect(() => {
    ...
    const extractImagesFromPDF = async () => {
      try {
        const loadingTask = pdfjsLib.getDocument("/drive-download-20250221T123148Z-001/Sample   Rear & Remodeling Timber Frame Cosntruction.pdf");
