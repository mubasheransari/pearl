...
const PDFImageBookViewer9 = () => {
  const [images, setImages] = useState([]);
  const [loading, setLoading] = useState(true);

  // The direct URL/path to your PDF file
  const pdfUrl =
    "/drive-download-20250221T123148Z-001/Sample  Earth Retaining Steel Structure Stair Design.pdf";
...
export default PDFImageBookViewer9;
