...
export const metadata = {
    ...
    alternates:{
        canonical: "https://pearlepp.co.uk/project-management"
      }    
  }
                ...
                <div className={`${style.category_box} container py-5 d-flex`}>
                    <div className={`${style.left}`}>
                        ...
                        <div className={`${style.category_text}`}>
                            <p>
                                Welcome to Pearl Engineers Planners and Project Managers (PEPP), a dynamic and innovative civil engineering design firm revolutionizing the world of project management services for small residential projects in the UK. With a passionate team of experienced professionals, PEPP is here to ensure that your dream home becomes a reality, right from conception to completion. <br />
