...
import { faChartPie, faHandshake, faHeadset, faPersonDigging, faRankingStar, faRulerCombined, faVest, faVihara } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className={`${style.services_box} container`}>
          ...
          <div className={`${style.service_cards}`}>
            ...
            <div className={`${style.card_box}`}>
              ...
              <h6>Detailed Engineering Plans</h6>
            ...
            <div className={`${style.card_box}`}>
              ...
              <h6>Post-Construction Support</h6>
