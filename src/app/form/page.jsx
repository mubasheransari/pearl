                ...
                <div className={`${style.form_div}`}>
                    <form onSubmit="#">
                                                        ...
                                                        <>
                                                            <label key={val.value}>
                                                                <input
                                                                    ...
                                                                    type="radio"
                                                                    value={val.value}
                                                                    checked={groundfloorselectedOption === val.value}
                        ...
                        <div className='my-5'>
                            ...
                            <div className="mb-2">
                                <input type="checkbox" className='mr-2' name="" value="" />
                                <label className='ml-2'>Keep me updated on PEPP news, events and offers.</label>
                            </div>
                        </div>

                        <div className={`${style.form_button_div}`}>
                            <button className={`${style.form_button} btn`} >
                                Submit
                            </button>
                        </div>
